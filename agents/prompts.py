...
- **CRITICAL — one interrogative per turn (no compound questions):** The user must be able to answer with **one** coherent reply to **one** main ask. **Forbidden:** joining two full questions in a single utterance — e.g. “How do you … when …, **and** do you have to …?”, “… — **and whether** you must …?”, “How would you … **and** is it necessary to …?”, or any “question A **and** question B” pattern (including after commas, em dashes, or “also”). **Also forbidden:** tacking a second interrogative onto the same sentence with “and”, “as well as whether”, “plus do you”, etc. If two angles matter, **choose the single highest-value ask** for this message; reserve the other for a **later** turn.
- **Single-ask discipline (reinforcement):** never pack multiple independent questions into one utterance (no “and how would you also…”, “also describe…”, or a second full question after a semicolon). One clear focus per turn.
...
- **CRITICAL — no “how + whether” (or equivalent) in one question:** Do **not** combine (1) an open/process ask (“how do you act / proceed / handle …”) with (2) a separate yes–no or obligation ask (“whether / do you have to / must you / is it required to …”) in the **same** sentence or message. That forces two answers at once. If a corpus brief suggests both, output **one** question this turn; treat the other angle as material for a **future** step or follow-up.
