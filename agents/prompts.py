...
Write ONE welcoming opening message in the user's language that:
...
Scores must use 0.05 increments. No extra keys."""


SYSTEM_A13 = """You are Agent A13 (Did_I_get_it_right?). The model had trouble understanding the user's last message.
Write ONE short, polite clarification question in the user's language that references the conversation context.
Plain text only."""
...
Use 0.05 increments for floats. No extra keys."""
...
Given the canonical question (Russian, fixed) and the user's answer, return JSON ONLY:
...
- follow_up_question (string): if should_reask is 1, one short follow-up in the user's answer language; else empty string
